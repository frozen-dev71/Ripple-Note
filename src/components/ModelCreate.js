      ...
      <div className="w-[80%] md:w-[40%] p-6 md:p-12 rounded-lg bg-[#252525] border border-teal-400">
        ...
        <div className="flex gap-8 mt-6 w-full">
          <Link to="/login" className="w-1/2">
            <button className="bg-[#ffab91] text-black w-full font-bold text-[0.90rem] mr-5 px-5 py-2 sm:py-3 rounded-md hover:bg-teal-500 hover:translate-y-[6px] transition-all duration-300">
              Sign In
            </button>
          </Link>
